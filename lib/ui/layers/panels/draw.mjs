...
export default layer => {
  ...
  const ICONS = {
    point: "https://raw.githubusercontent.com/GEOLYTIX/MapIcons/master/drawing/point.svg",
    polygon: "https://raw.githubusercontent.com/GEOLYTIX/MapIcons/master/drawing/polygon.svg",
    circle: "https://raw.githubusercontent.com/GEOLYTIX/MapIcons/master/drawing/circle.svg",
    isoline_here: "https://raw.githubusercontent.com/GEOLYTIX/MapIcons/master/drawing/isoline_here.svg",
  }
  ...
  const panel = mapp.ui.elements.drawer({
    ...
    // Render as tab display if more than one element exist
    content: elements.length > 1 ? content : elements,
  });
